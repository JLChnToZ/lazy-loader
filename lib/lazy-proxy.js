...
(function (LazyProxy) {
    ...
    class ConstructorLazyHandler extends LazyHandler {
        ...
        getOwnPropertyDescriptor(target, key) {
            return super.getOwnPropertyDescriptor(target, key) ||
                ...
                ConstructorLazyHandler.dummySealedDescriptors[key];
        }
        ownKeys(target) {
    ...
    __decorate([
        lazy_property_1.LazyProperty
    ], ConstructorLazyHandler, "dummySealedDescriptors", null);
    __decorate([
        lazy_property_1.LazyProperty
    ], ConstructorLazyHandler, "dummySealedKeys", null);
